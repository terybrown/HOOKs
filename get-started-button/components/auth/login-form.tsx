  ...
  return (
    <form onSubmit={handleLogin} className="flex flex-col gap-5">
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">Access your command center</p>
      </div>
      ...
      <Button
        type="submit"
        className="w-full bg-foreground text-background hover:opacity-90 font-semibold py-2"
      >
        Sign In
      </Button>
    </form>
